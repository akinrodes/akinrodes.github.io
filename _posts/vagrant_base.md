...
- On d√finit au moins un groupe all avec les variables communes √† toutes nos machines
  ```bash
...
- On cr√e un repertoire qui contiendra les identifiants et autre variables e rfocntion des groupes
  ...
  mkdir group_vars
  cd group_vars
  vim prod.yml  #ce fichier porte le m√™me nom que notre groupe prod definit dans hosts.yml et lui fait r√f√rence
  ``` 
